...
public class CardData : ScriptableObject
{
	...
	[Header("卡片費用"), Range(0, 10)] public int cardCost;
	[Header("卡片圖示")] public Sprite cardIcon;
	[Header("卡圖背景")] public Sprite cardBG;
	[Header("卡圖顏色")] public Color cardColor;
	[Header("卡片描述")][TextArea(3, 5)] public string cardDescription;
	// 生物卡專屬
	[Tooltip("生物卡用")][Header("攻擊力")] public int attack;
	[Tooltip("生物卡用")][Header("生命值")] public int health;
	[Tooltip("生物卡用")][Header("卡片屬性")] public string[] cardFeature;
}